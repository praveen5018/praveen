        ...
        <div id="body-bg">
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="pharmacist.jsp" class="fa-comment active">Pharmacist</a>
            ...
            <div id="content" class="bottom-border-shadow">
                <div class="container background-white bottom-border">
                    <center>
                    <br>
                    <h1><font color="black">Pharmacist Registration</font></h1>
                    
                    <br>
                      

         <form name="myform" action="pharmacistregact.jsp" method="post">
         <table border="0" >
             
         <tr><td><font color="black"> Pharmacist Id :</td><td><input type="text" name="id" required="" /></td></tr>
         <tr><td><font color="black"> Pharmacist Name :</td><td><input type="text" name="username" required="" /></td></tr>
