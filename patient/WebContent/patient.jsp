        ...
        <div id="body-bg">
            ...
            <div id="content" class="bottom-border-shadow">
                <div class="container background-white bottom-border">
                    <center>
                    <br>
                    <h1><font color="black">Patient Login</font></h1>
                    
                    <br>
                      

         <form name="myform" action="patientact.jsp" method="post">
         <table border="0" >

         <tr><td><font color="black"> Id :</td><td><input type="text" name="username" required="" /></td></tr>
         ...
         <tr></tr>      
                    ...
                    <br> <center>   <a href="patientreg.jsp" class="fa-registered ">Click Here for Registration</a></center><br>           
                    </div>
                </div>
            </div>
            <!-- Portfolio -->
