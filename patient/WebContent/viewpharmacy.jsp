...
<html lang="en">
    ...
    <body>
        <div id="body-bg">
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    <li>
                                        <a href="adminhome.jsp" class="fa-home  ">Home</a>
                                    </li>
                                    <li>
                                        <a href="viewpharmacy.jsp" class="fa-comment active">View Pharma</a>
                                       
                                    </li>
                                    <li>
                                        <a href="viewdoctor.jsp" class="fa-comment ">View Doctor</a>
                                    </li>                                    
                                    
                                    <li>
                                        <a href="viewpatient.jsp" class="fa-gears ">View Patient</a>
                                    </li>
          ...
          <center>
          <br>
                    <h1><font color="black">View Pharmacist</font></h1>                    
                    <br>
                    
                <%
                
                Connection con = Dbconnection.getConnection();
                PreparedStatement pst=con.prepareStatement("select * from pharmacist");
