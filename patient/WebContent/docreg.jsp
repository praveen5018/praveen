        ...
        <div id="body-bg">
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="doctor.jsp" class="fa-comment active">Doctor</a>
                                    </li>                                    
            ...
            <div id="content" class="bottom-border-shadow">
                <div class="container background-white bottom-border">
                    <center>
                    <br>
                    <h1><font color="black">Doctor Registration</font></h1>
                    
                    <br>
                      

         <form name="myform" action="docregact.jsp" method="post">
         <table border="0" >
             
         <tr><td><font color="black"> Doctor Id :</td><td><input type="text" name="id" required="" /></td></tr>
         <tr><td><font color="black"> Doctor Name :</td><td><input type="text" name="username" required="" /></td></tr>
