...
<head>
<title>AdminMain View Ranking::Arrribute Assisted Re Ranking</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View All Web Image Rankings </span></h2>
          <div class="clr style2"></div>
          
		  <div align="center">
  <p class="style3"><span class="style1"> View all ranking images details</span>for User Searched Images !!! </p>
  ...
  try{      
    ...
    while(rs.next()){
       ...
       %>
           ...
           <input  name="image" type="image" src="images.jsp?imgid=<%=rs.getInt(1)%>" width="100" height="100" alt="Submit"><%=rs.getInt(2)%>
