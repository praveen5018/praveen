...
<head>
<title>User Main Web Image Search::Arrribute Assisted Re Ranking</title>
...
<div class="main">
  ...
  <table width="505" border="0" align="center">
    <tr>
      <td width="212"><span class="style3">Enter the Secret Key to Search !!! </span></td>
      <td width="266"><input type="text" name="t1"></td>
