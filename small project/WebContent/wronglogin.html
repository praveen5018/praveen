...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 0" bordercolor="#111111" width="100%" id="AutoNumber1" height="1">
  <tr>
    ...
    <p align="center">
    <img border="0" src="../AgentModule/images/floppy_disk_walking_sm_nwm.gif" width="90" height="90"></td>
    <td width="20%" style="border-style: none; border-width: medium" height="1">
    </td>
    <td width="20%" style="border-style: none; border-width: medium" height="1">
    </td>
    ...
    <td width="20%" style="border-style: none; border-width: medium" height="1">
    <p align="center">
    <img border="0" src="../AgentModule/images/penguin_type_laptop_sm_nwm.gif" width="90" height="90"></td>
  </tr>
</table>
</TD>
</TR>
...
<BR><BR>
<a href="user.html">Click here to go back</a><BR>
<BR>
</font>
</td>
</tr>
