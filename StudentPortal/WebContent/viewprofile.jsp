...
<head>
  ...
  <%
    ...
    <script>alert('User Details Updated Sucefully');</script>
    <%}
        if (request.getParameter("m2") != null) {%>
    <script>alert('User Details Updated Not Sucefully');</script> 
	...
	<div class="container">
		<div class="row">
	<center>			
<h3 style="color:#109173"> View Profile</h3><br>
...
<table border="1" width=50%>
		...
		<td><%=rs.getString("email")%></td>
					...
					<td><img src="img/user.jpg" alt="jacket" width="80" height="70"></td>
					
					</tr>
					
					
					<tr>
					<td><b><a style="color:blue" href="modify.jsp?user=<%=rs.getString("uname")%>">EDIT</a></b></td>
					</tr>
		<% 
