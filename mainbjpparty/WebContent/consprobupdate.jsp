    ...
    <section id="services">
      <div class="container">
        <div class="section-header">
         ...
         <form action="consprobeditservlet.jsp" method="post" role="form" class="contactForm">
...
<br><br>
            ...
            <div class="form-row">
             ...
             <div class="form-group">
              <input type="text" class="form-control" name="status"value=<%=rs.getString(7) %> id="subject" placeholder="problem" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
              <div class="validation"></div>
            </div>
