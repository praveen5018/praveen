...
PreparedStatement pstmt=conn.prepareStatement("update problems set conname=?,divname=?,username=?, mobile=?,problems=?,message=? where username=?");
...
if(i==1){
	...
	RequestDispatcher rd=request.getRequestDispatcher("divedit.jsp");
