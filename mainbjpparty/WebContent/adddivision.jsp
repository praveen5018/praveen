    ...
    <section id="services">
      <div class="container">
        <div class="section-header">
         ...
         <form action="addservlet" method="post" role="form" class="contactForm">
       	 <div>
				Constitution : <select name="constitution">
                            <%
try{
	Class.forName("oracle.jdbc.driver.OracleDriver");
	java.sql.Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","anuroop","anuroop");
	PreparedStatement pstmt=conn.prepareStatement("select * from condiv where type=? ");
...
%>
		  ...
		  <div class="form-group">
              <input type="text" class="form-control" name="division" id="subject" placeholder="division" required=" " data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <input type="text" name="lastname" class="form-control" id="name" placeholder="Last Name"  data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validation"></div>
              </div>
            </div>
			<div class="form-row">
			...
			<div class="form-row">
              <div class="form-group col-md-6">
                <input type="text" name="repeatpassword" class="form-control" id="r_pass" placeholder="Repeat Password" onblur="repeatPass()"data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validation"></div>
              </div>
              <div class="form-group col-md-6">
            ...
            <div class="text-center"><button type="submit" onclick= "return confirm('Are you sure you want to add?'); ">Add Division</button></div>
          </form>
